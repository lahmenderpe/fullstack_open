...
describe("total likes", () => {
  ...
  test("should return the favorite blog", () => {
  ...
  test("should return the author who has the most amont of blogs", () => {
    const expectedResult = {
      author: 'Robert C. Martin',
      blogs: 3
    }
  ...
  test("shoudl return the author who has the most amont of blog likes", () => {
    const expectedResult = {
      author: 'Edsger W. Dijkstra',
      likes: 17
    }
